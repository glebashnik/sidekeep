...
var CircularProgress = React.createClass({
    ...
    getStyles: function getStyles(zoom) {
        ...
        var margin = Math.round((40 * zoom - 40) / 2);
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('circle', { ref: 'path', style: this.mergeAndPrefix(styles.path), cx: '20', cy: '20',
                        r: '18', fill: 'none', strokeWidth: '5', strokeMiterlimit: '10' })
                )
            )
        );
    }
